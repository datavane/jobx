  ...
  <div :val="value_" class="cron-container">
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
        <a-radio-button value="1">每月</a-radio-button>
      </a-radio-group>
    </div>
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
    ...
    <div class="line">
      ...
      <a-input-number @change="type = '2'" v-model="cycle.start" :min="1" :max="12" size="small"></a-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">至</span>
      <a-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="12" size="small"></a-input-number>
      月
    </div>
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
      ...
      <span style="margin-left: 10px; margin-right: 5px;">从</span>
      <a-input-number @change="type = '3'" v-model="loop.start" :min="1" :max="12" size="small"></a-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">月开始，每</span>
      <a-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="12" size="small"></a-input-number>
      月执行一次
    </div>
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
      ...
      <a-checkbox-group v-model="appoint" @change="type = '4'" >
          <a-checkbox @change="type = '4'"  v-for="i in 12" :key="i">{{i}}</a-checkbox>
      </a-checkbox-group>
    </div>
  </div>
</template>
