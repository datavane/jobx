  ...
  <div :val="value_" class="cron-container">
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
        <a-radio-button value="1">每日</a-radio-button>
      </a-radio-group>
    </div>
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
    ...
    <div class="line">
      ...
      <a-input-number @change="type = '2'" v-model="cycle.start" :min="1" :max="31" size="small"></a-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">至</span>
      <a-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="31" size="small"></a-input-number>
      日
    </div>
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
      ...
      <span style="margin-left: 10px; margin-right: 5px;">从</span>
      <a-input-number @change="type = '3'" v-model="loop.start" :min="1" :max="31" size="small"></a-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">日开始，每</span>
      <a-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="31" size="small"></a-input-number>
      日执行一次
    </div>
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
        <a-radio-button value="8">工作日</a-radio-button>
      </a-radio-group>
      <span style="margin-left: 10px; margin-right: 5px;">本月</span>
      <a-input-number @change="type = '8'" v-model="work" :min="1" :max="7" size="small"></a-input-number>
      号，最近的工作日
    </div>
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
        <a-radio-button value="6">本月最后一天</a-radio-button>
      </a-radio-group>
    </div>
    <div class="line">
      <a-radio-group v-model="type" size="small" buttonStyle="solid">
      ...
      <a-checkbox-group v-model="appoint">
        <div  v-for="i in 4" :key="i" @change="type = '4'"  style="margin-left: 10px;  line-height: 25px;">
          <a-checkbox @change="type = '4'"  v-for="j in 10" v-if="parseInt((i - 1) + '' + (j - 1)) < 32 && !(i === 1 && j === 1)" :key="j">{{(i - 1) + '' + (j - 1)}}</a-checkbox>
        </div>
      </a-checkbox-group>
    </div>
  </div>
