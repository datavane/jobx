...
public abstract class ClassAccessor {
    ...
    static class AccessorClassLoader extends ClassLoader {
        ...
        private static final WeakHashMap<ClassLoader, WeakReference<AccessorClassLoader>> accessorClassLoaders = new WeakHashMap<ClassLoader, WeakReference<AccessorClassLoader>>();
        ...
        static AccessorClassLoader get(Class<?> type) {
            ...
            synchronized (accessorClassLoaders) {
                ...
                accessorClassLoaders.put(parent, new WeakReference<AccessorClassLoader>(accessorClassLoader));
                return accessorClassLoader;
            }
        }
