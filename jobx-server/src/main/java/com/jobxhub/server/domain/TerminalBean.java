...
public class TerminalBean {
    ...
    public TerminalBean(Terminal terminal){
        BeanUtils.copyProperties(terminal,this);
    }

    public static Function<? super Terminal, ? extends TerminalBean> transfer = new Function<Terminal, TerminalBean>() {
        @Override
        public TerminalBean apply(Terminal input) {
            return new TerminalBean(input);
        }
    };
