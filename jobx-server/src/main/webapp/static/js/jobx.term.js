;function JobXTerm(token,_theme) {
    this.socket = null;
    this.term = null;
    this.token = token;
    this._theme = _theme;
...
;JobXTerm.prototype.getSize = function () {
...
;JobXTerm.prototype.open = function () {
    ...
    self.socket.onerror = function () {
        self.term.write("Sorry! jobx terminal connect error!please try again.\n");
        window.clearInterval(self.term._blink);
    };

    self.socket.onclose = function () {
        self.term.write("Thank you for using jobx terminal! bye...");
        //清除光标闪烁
        window.clearInterval(self.term._blink);
...
;JobXTerm.prototype.theme = function () {
    'use strict';
