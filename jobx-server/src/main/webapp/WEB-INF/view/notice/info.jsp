...
<c:forEach var="m" items="${message}" varStatus="index">
    ...
    <div class="media">
        ...
        <div class="media-body">
            <small class="text-muted">jobx告警 - <fmt:formatDate value="${m.sendTime}" pattern="yyyy-MM-dd HH:mm:ss"/></small><br>
            <a class="t-overflow" href="${contextPath}/notice/detail/${m.logId}.htm">${cron:escapeHtml(m.message)}</a>
        </div>
    </div>
