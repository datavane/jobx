...
public class Job implements Serializable {
    ...
    public static Function<JobModel,Job> transferDto = new Function<JobModel, Job>() {
        @Override
        public Job apply(JobModel input) {
            Job job = new Job();
    ...
    public static Function<Job,JobModel> transferModel = new Function<Job,JobModel>() {
        @Override
        public JobModel apply(Job input) {
            JobModel jobModel = new JobModel();
            BeanUtils.copyProperties(input,jobModel);
            return jobModel;
        }
    };
