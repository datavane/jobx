...
public class User implements Serializable {
    ...
    public static Function<UserModel,User> transferDto = new Function<UserModel, User>() {
        @Override
    ...
    public static Function<User,UserModel> transferModel = new Function<User,UserModel>() {
        @Override
        public UserModel apply(User input) {
            UserModel userModel = new UserModel();
            BeanUtils.copyProperties(input,userModel);
            if (input!=null&&input.getExecUser()!=null) {
                userModel.setExecUser(StringUtils.join(input.getExecUser(),","));
            }
            return userModel;
        }
    };
