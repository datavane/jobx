...
public class Record implements Serializable {
    ...
    public static Function<RecordModel,Record> transferDto = new Function<RecordModel, Record>() {
        @Override
        public Record apply(RecordModel input) {
    ...
    public static Function<Record,RecordModel> transferModel = new Function<Record,RecordModel>() {
        @Override
        public RecordModel apply(Record input) {
