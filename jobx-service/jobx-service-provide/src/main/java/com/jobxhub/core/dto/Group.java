...
public class Group implements Serializable {
    ...
    public static Function<? super GroupModel, ? extends Group> transferDto = new Function<GroupModel, Group>() {
        @Override
        public Group apply(GroupModel input) {
    ...
    public static Function<? super Group, ? extends GroupModel> transferModel = new Function<Group, GroupModel>() {
        @Override
