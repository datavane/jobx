...
public class Agent implements Serializable {
    ...
    private List<GroupModel> groups = new ArrayList<GroupModel>(0);
    ...
    public static Function<AgentModel,Agent> transferDto = new Function<AgentModel, Agent>() {
        @Override
        public Agent apply(AgentModel input) {
    ...
    public static Function<Agent,AgentModel> transferModel = new Function<Agent,AgentModel>() {
        @Override
        public AgentModel apply(Agent input) {
            AgentModel agentModel = new AgentModel();
            BeanUtils.copyProperties(input,agentModel);
            return agentModel;
        }
    };
