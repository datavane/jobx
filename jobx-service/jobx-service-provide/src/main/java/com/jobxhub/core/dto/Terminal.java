...
public class Terminal implements Serializable {
    ...
    public static Function<TerminalModel,Terminal> transferDto = new Function<TerminalModel, Terminal>() {
        @Override
        public Terminal apply(TerminalModel input) {
    ...
    public static Function<Terminal,TerminalModel> transferModel = new Function<Terminal,TerminalModel>() {
        @Override
        public TerminalModel apply(Terminal input) {
