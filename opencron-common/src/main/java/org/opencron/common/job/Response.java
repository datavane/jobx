...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (1.0.0-dev)", date = "2017-05-01")
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
    ...
    public java.util.Map<String, String> result; // required
    ...
    public Response(Response other) {
        ...
        if (other.isSetResult()) {
            java.util.Map<String, String> __this__result = new java.util.HashMap<String, String>(other.result);
    ...
    public void putToResult(String key, String val) {
        if (this.result == null) {
            this.result = new java.util.HashMap<String, String>();
        }
    ...
    public Response setResult(java.util.Map<String, String> result) {
        this.result = result;
        return this;
    }
        ...
        switch (field) {
            ...
            case RESULT:
                if (value == null) {
                    ...
                    setResult((java.util.Map<String, String>) value);
                }
                break;
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                            {
                                ...
                                struct.result = new java.util.HashMap<String, String>(2 * _map10.size);
                                String _key11;
                                String _val12;
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, Response struct) throws org.apache.thrift.TException {
            ...
            if (struct.result != null) {
                oprot.writeFieldBegin(RESULT_FIELD_DESC);
                {
                    ...
                    for (java.util.Map.Entry<String, String> _iter14 : struct.result.entrySet()) {
            ...
            if (struct.isSetResult()) {
                {
                    ...
                    for (java.util.Map.Entry<String, String> _iter15 : struct.result.entrySet()) {
            ...
            if (incoming.get(1)) {
                {
                    ...
                    struct.result = new java.util.HashMap<String, String>(2 * _map16.size);
                    String _key17;
                    String _val18;
