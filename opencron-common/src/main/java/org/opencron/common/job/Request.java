...
public class Request implements org.apache.thrift.TBase<Request, Request._Fields>, java.io.Serializable, Cloneable, Comparable<Request> {
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
        ...
        private static final java.util.Map<String, _Fields> byName = new HashMap<String, _Fields>();
    ...
    public Request(Request other) {
        ...
        if (other.isSetParams()) {
            java.util.Map<String, String> __this__params = new HashMap<String, String>(other.params);
    ...
    public Request setParams(java.util.Map<String, String> params) {
        this.params = params;
        return this;
    }
