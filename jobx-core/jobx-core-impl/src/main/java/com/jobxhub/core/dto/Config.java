...
public class Config implements Serializable {
    ...
    public static List<ConfigModel> toModel(Config config) {
        Field[] fields = ConfigModel.class.getDeclaredFields();
        List<ConfigModel> configBeans = new ArrayList<ConfigModel>(0);
        for (Field field:fields) {
            try {
                field.setAccessible(true);
                ConfigModel configBean = new ConfigModel();
    ...
    public void fromModel(ConfigModel config) {
