...
public class IdleServerHandler extends SimpleChannelInboundHandler<IdleRequest> {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	@Override
	protected void channelRead0(ChannelHandlerContext ctx, IdleRequest msg) throws Exception {
